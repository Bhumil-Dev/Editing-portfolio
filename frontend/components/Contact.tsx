...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden bg-dark-100">
      ...
      <motion.div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] opacity-10 blur-3xl"
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
            ...
            <div className="space-y-6 mb-10">
              {[
                { icon: '📧', label: 'EMAIL', value: 'bhumil@example.com', href: 'mailto:bhumil@example.com' },
                { icon: '💬', label: 'WHATSAPP', value: '+91 98765 43210', href: 'https://wa.me/919876543210' },
                { icon: '📍', label: 'LOCATION', value: 'India (Available Worldwide)', href: '#' },
              ].map(item => (
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              >💬 WHATSAPP ME</a>
              <a href="mailto:bhumil@example.com"
              ...
              {[
                ...
                <div key={f.name}>
                  ...
                  <input
                    ...
                    value={(form as any)[f.name]} onChange={onChange}
