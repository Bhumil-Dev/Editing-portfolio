...
const socials = [
  { label: 'Instagram', href: 'https://www.instagram.com/bhumil_0003/', color: '#E1306C',
  ...
  { label: 'LinkedIn', href: 'https://www.linkedin.com/in/bhumil-prajapati-07429a374/', color: '#0A66C2',
  ...
  { label: 'GitHub', href: 'https://github.com/Bhumil-Dev', color: '#ffffff',
...
export default function Footer() {
  return (
    <footer className="py-10 border-t" style={{ background: '#0a0a0a', borderColor: 'rgba(255,255,255,0.06)' }}>
      <div className="max-w-5xl mx-auto px-6">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm font-medium" style={{ color: 'rgba(255,255,255,0.5)' }}>Bhumil Prajapati</span>
          </div>
          ...
          <div className="flex items-center gap-2.5">
            {socials.map(s => (
              <motion.a key={s.label} href={s.href} target="_blank" rel="noreferrer" aria-label={s.label}
        ...
        <div className="mt-8 pt-6 text-center border-t" style={{ borderColor: 'rgba(255,255,255,0.05)' }}>
          <p className="text-xs" style={{ color: 'rgba(255,255,255,0.15)' }}>
            © {new Date().getFullYear()} Bhumil Prajapati. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
